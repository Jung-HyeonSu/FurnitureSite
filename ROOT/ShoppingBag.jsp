        ...
        <table width="100%" border="1">
            ...
            <%
             ...
             try {
                ...
                pstmt = conn.prepareStatement("select * from ProductDB.ProductTable as P, OrderDB.OrderTable as O where P.pcode = O.pcode and PayOrNot = false and ID = (?) order by OrderNum ASC");
                pstmt.setString(1, sessionid);
                rs = pstmt.executeQuery();


                String[] ONum = new String[100];
                int i=0;
                %>
                ...
                <tr>
                    <td><input type="checkbox" name="orderCheck" value = <%= ONum[i] %>></td>
                    <td><%= ONum[i] %></td>
           ...
           %>
            ...
            <br>
            <center>
            <button type="submit" name="confirm" formaction="orderProduct.jsp">결제</button>
            <button type="submit" name="confirm" formaction="minusProduct.jsp">장바구니 삭제</button>
        </center>
        </form>
