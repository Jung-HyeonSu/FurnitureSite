    ...
    <body>
        ...
        <table width="100%" border="1">
            ...
            <%
             ...
             ResultSet rs =null; 
             try {   
                String[] OrderNum = new String[100];
                int i=0;
                ...
                pstmt = conn.prepareStatement("select * from ProductDB.ProductTable as P, OrderDB.OrderTable as O where P.pcode = O.pcode and PayOrNot = true order by ID ASC, P.pcode DESC, OrderNum");
                ...
                <tbody>
                    <form method="get" action="managementOrderCancel.jsp">
                <%
                ...
                while(rs.next()){
                    ...
                    OrderNum[i] = rs.getString("OrderNum");
                %>
                
                
                <tr>
                    <td><input type="checkbox" name="OrderCancel" value = <%= OrderNum[i] %>></td>
