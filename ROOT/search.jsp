...
<div id="menu">
    ...
    <br><br><br><br>
        <form action="../search.jsp" method="get">
            <p align="center">
                <input type="text" name="search" style="width:34%;text-align:center;">
                <button type="submit" value="검색">&#x1F50D</button>
            </p>
        </form>
        ...
        <table width="100%" border="1">
            ...
            String search = request.getParameter("search");
             ...
             try {
                ...
                pstmt = conn.prepareStatement("select * from ProductTable where pname like concat('%',?,'%')");
